...
audio_path = os.path.join(dir_root, "sample_data", "sw061b001_master.wav")
annotation_output_path = os.path.join(dir_root, "results", "sw061b001_master_annotations.csv")
book_of_whales_output_path = os.path.join(dir_root, "results", "sw061b001_master_book_of_whales.pdf")
